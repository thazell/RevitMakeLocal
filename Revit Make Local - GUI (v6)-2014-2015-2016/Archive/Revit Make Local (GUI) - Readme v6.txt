...
#### Version 6 - 05/24/2012
a) Fixes problem with Revit version 12.  Revit 12 renamed a pop-up window from "Central File" to "Central Model" so Version 5 Revit Make Local wasn't recognizing and dismissing this window.  Fix assumes pop-up window will remain as "Central Model" in versions 13 and beyond.  (Submitted by Sarah Bergmann.)
